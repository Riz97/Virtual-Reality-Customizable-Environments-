...
It has been possible to use Gemini LLMs because of the implementation of a Pyhton Server that communicates directly with Gemini and send the responses to Unity, where they will be processed and analyzed bythe system.
