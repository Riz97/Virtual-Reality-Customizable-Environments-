...
In the third part of the work, we wanted to provide the user a framework capable of searching and downloading 3D objects directly from the online database called Sketchfab. We spent a good amount of time by searching how it could have been possible to do a tasks like this, and then implementing it in the framework. The user can search for models by using keywords and visualize the name of the object, the author of the object and an image preview of the object. Then he can download the model, by activating a server (similar to the LLMs server seen before) and in a scrollview he will see all the downloaded models and so he can decide which ones he would like in the custom environment.
